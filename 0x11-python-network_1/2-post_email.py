...
with the email as a parameter, and displays the decoded UTF-8 body of the response.
"""
import sys
import urllib.parse
...
def post_email(email, url):
    """
    Sends a POST request to the URL with the email as a parameter in JSON format.
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Error: Missing arguments. Please provide a URL and an email address.")
    except Exception as e:
